...
#define ALLOCATE_EXTRA(vmPtr, mainType, extraSize) (type *)memManager(vmPtr, NULL, 0, sizeof(mainType) + extraSize)
#define ALLOCATE_ARRAY(vmPtr, type, count) (type *)memManager(vmPtr, NULL, 0, sizeof(type) * count)
#define DEALLOCATE_ARRAY(vmPtr, arrayPtr, count) (type *)memManager(vmPtr, arrayPtr, sizeof(arrayPtr[0]) * count, 0)
